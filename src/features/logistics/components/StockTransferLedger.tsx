  ...
  return (
    <div className="space-y-4 animate-fadeIn text-left font-sans">
      <div className="bg-white border-2 border-gray-200 border-b-[6px] rounded-3xl p-5 space-y-4 font-sans">
        <h4 className="text-xs font-black uppercase text-gray-400 border-b pb-2">Historial de Embarques y Traslados de Inventario ({stockTransfers.length})</h4>
        ...
        {stockTransfers.length === 0 ? (
          ...
          <div className="divide-y divide-gray-100 font-sans text-xs">
            {stockTransfers.map(tr => {
              ...
              return (
                <div key={tr.id} className="py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 first:pt-0 font-sans">
                  ...
                  <div className="flex flex-wrap gap-1.5 shrink-0 font-sans">
                    ...
                    {isCancelled && (
                      <span className="text-gray-450 font-black uppercase text-[10px] bg-gray-50 border p-2 rounded-lg">Anulado</span>
                    )}
                  </div>
                </div>
              );
