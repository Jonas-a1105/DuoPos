...
export default function ShiftStatsGrid({ activeShift, shiftTotals, computedExpectedCash }: ShiftStatsGridProps) {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 text-left">
      ...
      <div className="bg-white border-2 border-gray-200 border-b-[6px] rounded-2xl p-4 flex flex-col justify-between h-28">
        ...
        <div>
          ...
          <span className="text-[8px] text-[#949494] font-extrabold uppercase block mt-0.5 leading-none">
            Inyectado inicial
          </span>
        </div>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 border-b-[6px] rounded-2xl p-4 flex flex-col justify-between h-28">
        ...
        <div>
          ...
          <span className="text-[8px] text-gray-450 font-black uppercase block mt-1 leading-none">
            De {shiftTotals.ticketCount} transacciones
          </span>
        </div>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 border-b-[6px] rounded-2xl p-4 flex flex-col justify-between h-28">
        ...
        <div>
          ...
          <span className="text-[8px] text-[#949494] font-bold uppercase block mt-1 leading-none">
            Cargos a Terminal
          </span>
        </div>
      </div>
      ...
      {(() => {
        ...
        return (
          <div className="bg-white border-2 border-gray-200 border-b-[6px] rounded-2xl p-4 flex flex-col justify-between h-28">
            ...
            <div>
              <span
                className={`text-xl md:text-2xl font-black font-mono ${netMoveAmt >= 0 ? 'text-emerald-505' : 'text-amber-505'}`}
              >
                {netMoveAmt >= 0 ? '+' : '-'}${Math.abs(netMoveAmt).toFixed(2)}
              </span>
              <span className="text-[8px] text-[#949494] font-bold uppercase block mt-1 leading-none">
                {activeShift.movements.length} Entradas/Salidas
              </span>
            </div>
          </div>
        );
      ...
      <div className="bg-white border-2 border-gray-250 border-b-[6px] rounded-2xl p-4 flex flex-col justify-between h-28 bg-[#fafafa]">
        ...
        <div>
          ...
          <span className="text-[8px] text-gray-400 font-black uppercase block mt-1 leading-none">
            Efectivo teórico total
          </span>
        </div>
      </div>
    </div>
