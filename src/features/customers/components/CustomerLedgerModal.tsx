...
export default function CustomerLedgerModal({ customer, onClose }: CustomerLedgerModalProps) {
      ...
      <div className="bg-white border-2 border-gray-200 border-b-8 rounded-3xl max-w-md w-full p-6 space-y-4 relative shadow-2xl">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="text-left">
            <span className="text-[10px] uppercase font-black text-[#1cb0f6] block leading-tight">
        ...
        <div className="grid grid-cols-3 gap-2 bg-gray-100 border p-3 rounded-2xl text-center">
          ...
          <div>
            ...
            <span className="text-xs font-black font-mono text-red-500">${(customer.creditUsed || 0).toFixed(2)}</span>
          </div>
          <div>
        ...
        <div className="space-y-2">
          <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider text-left">
            Línea de Movimientos Históricos
          </h4>
                ...
                return (
                  ...
                  >
                    <div className="flex gap-2 text-left min-w-0">
                      <span
                        className={`text-lg p-1 rounded-lg shrink-0 w-8 h-8 flex items-center justify-center ${
                      ...
                      <div className="min-w-0">
                        <span
                          className={`text-[10px] font-black uppercase block ${isPay ? 'text-green-700' : 'text-red-700'}`}
                        >
                          {isPay ? 'Abono / Pago Recibido' : 'Cargo a Deuda'}
                        </span>
                        <p className="text-gray-800 break-words font-extrabold mt-0.5">
                          {mv.notes || 'Compra de mercancía'}
                        </p>
