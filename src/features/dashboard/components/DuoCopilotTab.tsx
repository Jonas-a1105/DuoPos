...
export default function DuoCopilotTab({
  user,
  transactions,
  products,
  onGrantXp
  ...
  const [copilotQuery, setCopilotQuery] = useState<string>(
    '¿Cómo puedo duplicar las ventas de mi producto estrella?'
  );
              ...
              {copilotLoading && (
                <div className="bg-slate-900 border border-slate-950 rounded-3xl p-8 flex flex-col items-center justify-center text-center space-y-4 min-h-[300px]">
                  <div className="relative">
                    ...
                    <Brain size={48} className="text-[#a855f7] animate-pulse relative animate-spin" style={{ animationDuration: '4s' }} />
                  </div>
