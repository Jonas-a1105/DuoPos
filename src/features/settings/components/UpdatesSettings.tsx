...
import { Laptop, Cpu, RefreshCw, Database, Globe, Check, Info } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fadeIn text-left">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-black uppercase text-gray-800 tracking-tight font-sans">
              Centro de Actualizaciones DuoPOS (.exe)
            </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-sans text-gray-700">
        <div className="bg-white border-2 border-gray-200 rounded-2xl p-4 space-y-2">
          ...
          <p className="text-[9.5px] font-bold text-gray-400 uppercase leading-none mt-2">
            Firma Local Validada por Duo Guard
          </p>
        </div>
        ...
        <div className="bg-linear-to-b from-gray-50 to-white border-2 border-gray-200 rounded-2xl p-5 space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-[10px] text-gray-400 font-extrabold uppercase leading-none">
              Verificación directa contra los servidores oficiales de DuoPOS
            </p>
            <p className="text-xs text-gray-500 leading-relaxed pt-1 font-bold lowercase">
              ...
              Wi-Fi). El sistema consultará de forma segura el manifest oficial.
            </p>
          </div>
          ...
          {isCheckingOnline && (
            <div className="bg-slate-900 text-[#1cb0f6] border border-slate-950 p-4 rounded-xl font-mono text-[11px] leading-relaxed space-y-1">
              ...
              <div className="text-slate-400 font-bold">
                [INFO] Verificando compatibilidad con el entorno .exe de Windows...
              </div>
              <div className="text-slate-400 font-bold">
          ...
          {onlineCheckResult === 'up_to_date' && !isCheckingOnline && (
            <div className="bg-emerald-50 border border-emerald-250 p-4 rounded-xl space-y-2 text-center text-emerald-950 font-bold text-xs">
              ...
              <p className="text-[10px] text-emerald-755 uppercase leading-normal">
                Felicidades, DuoPOS está corriendo la última versión disponible ({appVersion}) liberada en la racha
                actual.
              </p>
            </div>
          )}
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 text-[10px] text-amber-900 font-bold leading-normal flex gap-2">
            ...
            <div className="space-y-1 uppercase text-left">
              ...
              <p className="text-gray-500 lowercase leading-relaxed font-semibold">
                Puedes descargar la clave (.upd) de tu sucursal ingresando a la consola de soporte de DuoPOS. Pásalo al
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pt-4 border-t-2 border-dashed border-gray-200 font-sans text-gray-700">
        ...
        <div className="bg-white border-2 border-gray-200 border-b-[6px] rounded-3xl p-5 space-y-4">
          <span className="text-[9px] uppercase font-black tracking-widest text-purple-650 block leading-none">
            Wrapper & Native Bundler
          </span>
          <div className="flex items-center gap-1.5">
            <Laptop size={18} className="text-purple-600 animate-pulse" />
            <h4 className="text-sm font-black text-gray-850 uppercase tracking-tight leading-none pt-1">
              Centro de Compilación (.EXE/.APK)
            </h4>
          </div>
          <p className="text-xs text-gray-500 font-bold uppercase leading-normal">
            ¿Quieres ejecutar DuoPOS como software local .exe instalable o app Android nativa en lugar del navegador?
            ¡Usa nuestros envolventes listos para compilar!
          </p>
          ...
          {compilationWrapper === 'tauri' && (
            <div className="space-y-3 animate-fadeIn text-slate-800">
              <div className="bg-purple-55 border border-purple-150 rounded-2xl p-4 text-xs font-bold text-purple-950 space-y-2 uppercase leading-normal">
                ...
                <p className="font-semibold text-gray-500 lowercase leading-relaxed">
                  Tauri compila tu sitio React a binarios nativos de menos de 10MB que corren ultra-rápido y con
                  bajísimo consumo de memoria RAM (menos de 40MB).
                </p>
                <div className="bg-white rounded-xl p-3 border border-purple-100 space-y-1 text-[9.5px]">
                  ...
                  <p className="text-gray-550 font-bold lowercase">
                    1. Instala:{' '}
                    <span className="font-mono text-slate-800 bg-gray-100 p-0.5 rounded px-1">
                      npm install @tauri-apps/cli -D
                    </span>
                  </p>
                  <p className="text-gray-555 font-bold lowercase">
                    2. Corre:{' '}
                    <span className="font-mono text-slate-805 bg-gray-100 p-0.5 rounded px-1">npx tauri init</span> y
                    copia la config en{' '}
                    <span className="font-mono text-slate-805 bg-gray-100 p-0.5 rounded px-1">
                      src-tauri/tauri.conf.json
                    </span>
                  </p>
                  <p className="text-gray-555 font-bold lowercase">
                    3. Compila con:{' '}
                    <span className="font-mono text-slate-805 bg-gray-100 p-0.5 rounded px-1">npx tauri build</span>{' '}
                    para obtener tu instalador{' '}
                    <span className="font-mono text-[#58cc02] bg-[#e5f6ff] p-0.5 rounded px-1 font-black">
                      .EXE / .MSI / .DMG
                    </span>
                  </p>
                </div>
          ...
          {compilationWrapper === 'electron' && (
            <div className="space-y-3 animate-fadeIn">
              <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4 text-xs font-bold text-blue-950 space-y-2 uppercase leading-normal">
                ...
                <p className="font-semibold text-gray-550 lowercase">
                  Electron es el estándar mundial (usado por Discord y VSCode). Es la forma más rápida y amigable de
                  compilar tu POS con Node.js puro sin instalar Rust.
                </p>
                <div className="bg-white rounded-xl p-3 border border-blue-100 space-y-1 text-[9.5px]">
                  ...
                  <p className="text-gray-450 font-bold lowercase">
                    1. Ejecuta:{' '}
                    <span className="font-mono text-slate-800 bg-gray-100 p-0.5 rounded px-1">
                      npm install electron electron-builder -D
                    </span>
                  </p>
                  <p className="text-gray-455 font-bold lowercase">
                    2. Genera un archivo{' '}
                    <span className="font-mono text-slate-800 bg-gray-105 p-0.5 rounded px-1">main.js</span> en la raíz
                    e instala la estructura de abajo.
                  </p>
                  <p className="text-gray-455 font-bold lowercase">
                    3. Corre:{' '}
                    <span className="font-mono text-slate-805 bg-gray-105 p-0.5 rounded px-1">
                      npx electron-builder build --win
                    </span>{' '}
                    para generar el instalador de Windows{' '}
                    <span className="font-mono text-[#1cb0f6] bg-blue-50 p-0.5 rounded px-1 font-black">
                      DuoPOS-setup.exe
                    </span>
                  </p>
                </div>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  <span className="text-[10px] uppercase font-black tracking-wide text-gray-400">
          ...
          {compilationWrapper === 'capacitor' && (
            <div className="space-y-3 animate-fadeIn">
              <div className="bg-emerald-50 border border-emerald-250 rounded-2xl p-4 text-xs font-bold text-emerald-950 space-y-2 uppercase leading-normal">
                ...
                <p className="font-semibold text-gray-550 lowercase">
                  Capacitor de Ionic te permite empaquetar tu código web y transpilarlo instantáneamente a un instalador
                  de Android (.apk) nativo que puedes cargar vía USB en tablets o celulares.
                </p>
                <div className="bg-white rounded-xl p-3 border border-emerald-100 space-y-1 text-[9.5px]">
                  ...
                  <p className="text-gray-450 font-bold lowercase">
                    1. Instala:{' '}
                    <span className="font-mono text-slate-850 bg-gray-100 p-0.5 rounded px-1">
                      npm install @capacitor/core @capacitor/cli @capacitor/android -D
                    </span>
                  </p>
                  <p className="text-gray-455 font-bold lowercase">
                    2. Corre:{' '}
                    <span className="font-mono text-slate-850 bg-gray-100 p-0.5 rounded px-1">npx cap init</span> y
                    luego{' '}
                    <span className="font-mono text-slate-850 bg-gray-100 p-0.5 rounded px-1">npx cap add android</span>
                  </p>
                  <p className="text-gray-455 font-bold lowercase">
                    3. Transpila montajes con:{' '}
                    <span className="font-mono text-slate-850 bg-gray-105 p-0.5 rounded px-1">
                      npm run build && npx cap sync
                    </span>{' '}
                    abriendo Android Studio para compilar.
                  </p>
                </div>
              </div>
        ...
        <div className="bg-white border-2 border-gray-200 border-b-[6px] rounded-3xl p-5 space-y-4">
          <span className="text-[9px] uppercase font-black tracking-widest text-[#58cc02] block leading-none">
            Local SQLite Bridge Database
          </span>
          <div className="flex items-center gap-1.5">
            <Database size={18} className="text-[#58cc02]" />
            <h4 className="text-sm font-black text-gray-850 uppercase tracking-tight leading-none pt-1">
              Exportador de Base de Datos SQLite (.SQL Seed)
            </h4>
          </div>
          <p className="text-xs text-gray-500 font-bold uppercase leading-normal font-sans">
            ¿Cómo funciona la base de datos local en tu exe? Utiliza almacenamiento local adaptativo que se sincroniza
            dinámicamente. Extrae un script de SQL puro para sembrar tu base de datos física local.
          </p>
          ...
          <div className="bg-sky-50 text-sky-950 border border-sky-200 rounded-2xl p-4 text-[10.5px] font-bold space-y-1 leading-normal uppercase">
            ...
            <p className="text-gray-550 font-semibold lowercase leading-relaxed">
              Cuando corres tu DuoPOS.exe (con Tauri), el frontend utiliza indexDB/localStorage mediante hooks. Si
              requieres inicializar una base de datos física autónoma en tu SQLite local en el PC, este exportador de
              abajo leerá tus datos registrados en este navegador actual y te armará el script SQL pre-sembrado listo
              para inyectar:
            </p>
          </div>
          ...
          <div className="space-y-3 pt-1">
            <button
              ...
              onClick={() => {
                try {
                  ...
                  let parsedTrans = [];
                  try {
                    parsedProds = JSON.parse(rawProds);
                  } catch {}
                  try {
            ...
            <p className="text-[10px] text-gray-400 font-bold uppercase text-center mt-1 select-none">
              Sincronización instantánea validada por Duo Guard
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-orange-200/50 rounded-3xl p-5 md:p-6 space-y-4 font-sans text-gray-700">
        <span className="text-[9px] uppercase font-black tracking-widest text-orange-655 block leading-none font-sans">
          Cloud Computing & Deploy
        </span>
        <div className="flex items-center gap-1.5">
          <Globe size={18} className="text-orange-600 font-bold font-sans" />
          <h4 className="text-sm font-black text-gray-850 uppercase tracking-tight leading-none pt-1">
            Guía para subir la aplicación online gratis en servidores
          </h4>
        </div>
        <p className="text-xs text-gray-500 leading-relaxed font-bold uppercase leading-normal">
          ¿Quieres colocar de verdad esta aplicación en internet para que cualquiera acceda mediante un enlace público o
          página web sin instalar nada, de forma absolutamente estable y GRATUITA? Sigue este mapa de ruta corporativo:
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-1 text-left">
          ...
          <div className="bg-white border-2 border-gray-150 p-4 rounded-2xl space-y-2 flex flex-col justify-between">
            <div className="space-y-1.5">
              <span className="bg-gray-100 text-gray-750 font-black px-1.5 rounded text-[8px] uppercase">
                PASO 1: Subir código
              </span>
              <h5 className="font-extrabold text-xs text-purple-950 uppercase tracking-tight font-sans">
                Vincular a GitHub
              </h5>
              <p className="text-[10px] text-gray-400 font-bold tracking-tight lowercase leading-relaxed">
                Exporta tu código en tu AI Studio usando el menú superior derecho (botón Descargar ZIP) o súbelo usando
                git directamente desde tu ordenador para tener tu repositorio en la nube.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border-2 border-gray-150 p-4 rounded-2xl space-y-2 flex flex-col justify-between text-left">
            <div className="space-y-1.5">
              <span className="bg-blue-50 text-blue-600 border border-blue-105 font-black px-1.5 rounded text-[8px] uppercase">
                PASO 2: Proveedor Elástico
              </span>
              <h5 className="font-extrabold text-xs text-purple-950 uppercase tracking-tight font-sans">
                Elegir Servidor Gratis
              </h5>
              <p className="text-[10px] text-gray-400 font-bold tracking-tight lowercase leading-relaxed">
                Crea una cuenta gratuita en una de estas tres plataformas gigantes mundiales de hospedaje elástico que
                tienen tiers gratuitos permanentes:
              </p>
          ...
          <div className="bg-white border-2 border-gray-150 p-4 rounded-2xl space-y-2 flex flex-col justify-between">
            <div className="space-y-1.5">
              <span className="bg-emerald-50 text-emerald-600 border border-emerald-105 font-black px-1.5 rounded text-[8px] uppercase">
                PASO 3: Lanzar al aire
              </span>
              <h5 className="font-extrabold text-xs text-purple-950 uppercase tracking-tight font-sans">
                Enlazar y Sincronizar
              </h5>
              <p className="text-[10px] text-gray-400 font-bold tracking-tight lowercase leading-relaxed">
                Vincula tu cuenta de GitHub con Vercel/Railway. Al seleccionar este repositorio, la nube compilará el
                código y te dará un enlace único seguro HTTPS para compartir.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-orange-100/40 border border-orange-200/50 rounded-2xl p-4 flex gap-3 text-xs text-orange-900 font-bold uppercase text-[9.5px] text-left">
          ...
          <div className="flex-1 space-y-1 lowercase text-left">
            <p className="text-orange-950 font-black uppercase tracking-tight leading-none">
              ¡Conexión y DNS Segura HTTPS Gratis Incluida!
            </p>
            <p className="text-gray-500 font-bold">
              Estas plataformas te otorgan certificados SSL/TLS (HTTPS) automáticamente de forma ilimitada para que
              cargues tus ventas en tu celular o PC de oficina de manera segura y confidencial en internet.
            </p>
          </div>
        </div>
      </div>
