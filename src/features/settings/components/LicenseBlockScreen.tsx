...
import { validateLicenseKeyOnline, PLANS } from '../../../services/security/licensingService';
          ...
          {isClockTampered ? (
            ...
            <div className="space-y-5">
              ...
              <form onSubmit={handleBlockActivate} className="space-y-4 pt-2 border-t border-slate-800/80">
                <div className="space-y-1">
                  <label className="text-[10px] font-black tracking-wide text-slate-400 uppercase">Nombre de la Empresa / Cliente</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-black tracking-wide text-slate-400 uppercase">Clave de Licencia Comercial</label>
                  <input
                    type="text"
                    required
