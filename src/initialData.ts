...
export const DUO_CHARACTERS: Record<string, Character> = {
  duo: {
    ...
    intro: 'El fénix guardián y mentor del negocio. ¡Que nadie pierda la racha de ventas!',
  ...
  lily: {
    ...
    intro: 'La alquimista y cajera experta. No le pagan lo suficiente por sonreír, pero hace excelente cuadre de caja.',
  ...
  zari: {
    ...
    intro: 'La hada optimista de las ventas. El servicio al cliente es su mayor súper pasión.',
  ...
  eddy: {
    ...
    intro: 'El gerente y defensor del gremio. Para él, atender el POS es equivalente a una maratón de cardio extremo.',
  ...
  junior: {
    ...
    intro: 'El escudero aprendiz. Le encanta jugar con el escáner de barras y preguntar cosas.',
...
export const DEFAULT_BILLING_SETTINGS: LegalBillingSettings = {
  ...
  companyAddress: 'Avenida del Fénix Dorado #77, Sector Finanzas, CDMX',
