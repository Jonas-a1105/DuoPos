  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status === 'complete') {
        ...
        const userId = result.firstFactorImageAddress || result.createdSessionId; // ID del usuario de Clerk
        ...
        if (!finalProfile) {
          ...
          const currentClerkUser = result.userData || {};
          if (currentClerkUser.id) {
            defaultProfile.id = currentClerkUser.id;
          }
