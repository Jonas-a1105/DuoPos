...
import { Search, Calendar, User as UserIcon, DollarSign, RefreshCcw, Landmark, Receipt, Sparkles, Filter, CreditCard } from 'lucide-react';
          ...
          {activeReceipt ? (
            <div className="bg-white border-2 border-[#e5e5e5] border-b-[8px] rounded-3xl p-5 md:p-6 space-y-5 shadow-sm sticky top-4 animate-scaleUp">
              ...
              <div className="text-center pb-4 border-b-2 border-dashed border-gray-200 space-y-2">
                ...
                <p className="text-xs text-gray-400 font-extrabold uppercase tracking-wide leading-none">
              ...
              <div className="space-y-1.5 text-xs font-bold text-gray-500">
                ...
                <div className="flex justify-between items-center text-lg font-black text-gray-800 border-t border-gray-100 pt-2">
              ...
              {activeReceipt.invoiceData && (
                <div className="bg-[#fafafa] border-2 border-gray-150 rounded-2xl p-4 space-y-3.5">
                  ...
                  <div className="text-[10px] font-mono space-y-1 text-gray-600 bg-white p-3 border rounded-xl shadow-inner">
