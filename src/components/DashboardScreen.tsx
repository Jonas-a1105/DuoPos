...
export default function DashboardScreen({ user, transactions, products, onSetNewGoal, onNavigateToSell, onGrantXp, onUpdateUser }: DashboardScreenProps) {
...
Por favor, analízalo con tu telemetría avanzada y dame insights de calibre mundial.`;
  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-fadeIn font-sans pb-10">
      ...
      {/* WIDGET DE TRABAJO EN EQUIPO / META COOPERATIVA DE SUCURSAL */}
      {(() => {
        ...
        const handleClaimBranchReward = () => {
          ...
          if (onUpdateUser) {
            ...
            alert('¡Excelente! Has reclamado el Bono de Trabajo en Equipo de la Sucursal: +50 Gemas 💎. ¡Felicidades a todo el equipo!');
          }
        };

        return (
          <div className="duo-theme-card p-6 shadow-sm border-2 border-indigo-200 border-b-[8px] rounded-3xl grid grid-cols-1 md:grid-cols-3 gap-6 items-center mt-6">
            <div className="md:col-span-2 space-y-3">
              <div className="flex justify-between items-end">
                <div>
              ...
              {/* Cashiers Contribution breakdown list */}
