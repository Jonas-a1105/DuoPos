...
export type DuoMood = 'neutral' | 'happy' | 'sad' | 'sleepy';
...
const DuoMascot: React.FC<DuoMascotProps> = ({
  ...
  const renderEyes = () => {
    // Happy: ojos curvados de alegría
    if (mood === 'happy') {
      return (
  ...
  const bounceClass = mood === 'happy' && animate ? 'duo-bounce-happy' : '';
