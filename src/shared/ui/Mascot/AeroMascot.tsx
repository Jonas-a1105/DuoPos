      ...
      case 'accessory-capa':
        return (
          <g className="aero-accessory-capa">
            <path className="duo-cape-wave" d="M32 45 Q26 70 20 102 Q18 118 30 126 Q45 134 60 130 Q75 134 90 126 Q102 118 100 102 Q94 70 88 45" fill="url(#fireCapeGrad)" stroke="#b91c1c" strokeWidth="1.5" opacity="0.9" />
          </g>
        );
      default:
        return null;
    ...
    <div className={wrapperClass} style={{ width: size, height: size * (140 / 120), display: 'inline-flex', alignItems: 'center', justifyContent: 'center', overflow: 'visible' }}>
      <svg viewBox={vb} width={size} height={size * (140 / 120)} xmlns="http://www.w3.org/2000/svg" style={{ overflow: 'visible' }}>
        ...
        <g className="aero-mascot-body">
          ...
          {stage === 'baby' && <ellipse cx="60" cy="115" rx="5" ry="8" fill="#ef4444" />}
          {stage === 'teen' && (
